...
<section class="view-property">
   ...
   <div class="details">
     <div class="swiper images-container">
      ...
      <p class="location"><i class="fas fa-map-marker-alt"></i>      <a href="https://www.google.com/maps/place/<?php echo urlencode($fetch_property['address']); ?>" target="_blank"><?php echo $fetch_property['address']; ?></a>
      </p>

      <div class="info">
         <p><span><?= $fetch_property['price']; ?></span><span> DA</span></p>
      ...
      <div class="box">
         <?php
            if (isset($_POST["submit_address"]) && isset($_POST["address"]) && isset($fetch_property['address'])) {
               $address = $_POST["address"];
               ?>
               <iframe width="100%" height="500" src="https://maps.google.com/maps?q=<?php echo urlencode($address); ?>&output=embed"></iframe>
               <?php
            } elseif (isset($fetch_property['address'])) {
               ?>
               <iframe width="100%" height="500" src="https://maps.google.com/maps?q=<?php echo urlencode($fetch_property['address']); ?>&output=embed"></iframe>
               <?php
            }
         ?>
         <form method="POST">
            <p class="centered-text"><a class="caption" href="https://www.google.com/maps/place/<?php echo isset($fetch_property['address']) ? urlencode($fetch_property['address']) : ''; ?>" target="_blank"><?php echo isset($fetch_property['address']) ? $fetch_property['address'] : ''; ?></p>
